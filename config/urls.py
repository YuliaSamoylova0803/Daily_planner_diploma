...
router.register(r"defect-statements", DefectStatementViewSet, basename="defectstatement")
...
urlpatterns = [
    ...
    path('api/notes/<int:pk>/generate-statement/', generate_statement, name='generate-statement'),
    path('api/notes/<int:pk>/send-telegram/', send_telegram_notification, name='send-telegram'),
...
# Документация
    ...
    path('docs/', TemplateView.as_view(
        ...
        extra_context={'api_url': '/api/docs'}
    ), name='docs'),
